...
public class Textures {
    ...
    public static final AnimationSequence ANIM_PLAYER_IDLE =
            new AnimationSequence(PLAYER_IDLE, 6,
                                  0, 0, 0, 1, 0, 2, 0, 3);
    public static final AnimationSequence ANIM_PLAYER_WALK =
            new AnimationSequence(PLAYER_WALK, 6,
                                  0, 0, 0, 1, 0, 2, 0, 3);
    public static final AnimationSequence ANIM_PLAYER_RUN  =
            new AnimationSequence(PLAYER_RUN, 6,
                                  0, 0, 0, 1, 0, 2, 0, 3);
    public static final AnimationSequence ANIM_PLAYER_JUMP =
            new AnimationSequence(PLAYER_JUMP, 6,
                                  0, 0, 0, 1, 0, 2, 0, 3);
}
